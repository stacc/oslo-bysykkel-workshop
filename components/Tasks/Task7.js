        ...
        <div>
            ...
            <div className={styles.tasks}>
                ...
                <ul className={styles.listWithIconsPin}>
                    ...
                    <li>
                        Tips: Her må man slå sammen data; dette gjøres ved å finne fellesnevnerene ved de to forskjellige
                        datasettene, for eksempel en ID og så bruke de to datapunktene til å lage et nytt datapunkt.
