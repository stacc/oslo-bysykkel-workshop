...
export default function Task1() {
    return (
        <div>
            <TLDR>
                <p>
                    <b>Kort fortalt: </b>Endre på 💪-emojien i tittelen på
                    fremsiden av nettsiden vår.
                </p>
            </TLDR>
            <br/>
            <p className={styles.section}>
                NextJS er et rammeverk som bygger på React. En fordel NextJS gir oss, er en forenklet måte å jobbe med
                linker og måter å hente data på.
            </p>
            <p className={styles.section}>
                Et av de viktigste konseptene i NextJS er <code>pages</code> mappen. Alle
                filer i<code> pages</code> mappen vil bli en ny side på nettsiden vår.
                For eksempel hvis en lager en fil i <code>pages</code> som heter{" "}
                <code>banan</code> vil url-en til denne siden bli{" "}
                <code>localhost:3000/banan</code>.
            </p>
            <p>
                Det er også mulig å bruke mapper til
                ...
                Hvis vi tar bananan eksempelet vårt, og vi putter
            ...
            <p className={styles.section}>Dette er lettere å skjønne når man ser det i kode enn når man får det forklart, så se i koden på
            ...
            <ul>
                <li>
                    Finn overskriften på forsida, og endre 💪-emojien.
                </li>
            </ul>
