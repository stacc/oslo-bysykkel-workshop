...
export default function Task3() {
    ...
    return (
        <div>
            <TLDR>
                <p>
                    <b>Kort fortalt: </b>Hent ut de lengste turene fra historisk data fra Bysykkel. <br/>
            ...
            <b>Beskrivelse:</b>
            <div>
                Til å begynne med, har vi hentet ut et par historiske datasett som vi kan leke oss litt med.
                Her har vi laget en side som tar en sykkelrute, og
                viser raskeste vei fra A til B. (NB:
                Dette er ikke en faktisk rute, men er en beregnet rute
                mellom start- og sluttstoppet.)
                <br/>
                <br/> Dersom man ser i mappen <code>data</code> så har vi et sett med filer, som heter {" "}
                <code>01.json</code>, <code>02.json</code>, <code>03.json</code>, etc. Hver fil samsvarer med en måned i
                2022. Alle disse filene
                inneholder tonnevis med tekst. I denne teksten, skjuler det seg
                Om dere ser i en av disse filene så vil dere se tonnevis med tekst.
                Bak denne skjuler det seg lister over ulike sykkelturer som er gjort med
                Bysykler. Her er et utdrag av en av turene:
                <br/>
                <br/>
                <code>
                    {"{"}
                ...
                <br/>
                <br/>
                Her ser vi når turen startet, når den sluttet, hvor lenge den
                varte (i sekunder), informasjon om start-stativet (navn, hvor den er,
                ...
                geografiske koordinatene).
                <br/>
                <br/>
                På toppen av denne siden (linje 92 i koden) finner du et kart som kan brukes til å vise reisen. I denne
                filen finner du også koden som tar
               ti av turene og beregner korteste sykkeldistanse mellom start- og
