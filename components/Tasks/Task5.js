    ...
    <div>
      ...
      <div className={styles.tasks}>
        ...
        <ul className={styles.listWithIconsPin}>
          <li>
            Hent ut din nåværende lokasjon (
            <code>/utils/getCurrentLocation</code>)
          </li>
          <li>
            {" "}
            Bruk den sammen med liste over stasjoner for å finne den stasjonen
            som er nærmest deg (<code>/utils/getClosestStation</code> ).
          </li>
          <li>Tegn stasjonen på kartet.</li>
        </ul>
      </div>
      <Map>
        {/* Passer kordinat state inn i longitude og latitude under */}
        <Marker longitude={5.232378174459371} latitude={60.2868679444605}>
